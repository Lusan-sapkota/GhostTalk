...
class Config:
    ...
    APPWRITE_STORAGE_ID_FREE_AVATAR = os.environ.get('APPWRITE_AVATAR_BUCKET_ID', os.environ.get('APPWRITE_STORAGE_ID_FREE_AVATAR'))
    APPWRITE_COLLECTION_ID_TICKETS = os.environ.get('APPWRITE_COLLECTION_ID_TICKETS')
